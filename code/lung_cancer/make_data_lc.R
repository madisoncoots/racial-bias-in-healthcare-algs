...
# ======================
# Code for constructing lung cancer analysis data. 
# Coots et al. (2025)
...
# =============================================================================
# Note: The data used for the lung cancer analysis are not publicly available, 
# so we are not able to provide these data for replication.
...
data <- raw_data %>%
  ...
  select(
    ...
    conflc,
    year) %>%
  filter(years_quit >= 0, # bad data where age_quit > current age
